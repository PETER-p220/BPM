<template>
      ...
      <div class="container px-4 mx-auto">
        <div class="w-full shadow-lg card">
          ...
          <div class="p-6 bg-white card-body">
            <h3 class="mb-4 text-lg font-semibold">Submit Receipt</h3>
  
            <!-- Accountant Selection -->
            <div class="row">
              <div class="col-sm-6">
                <label for="accountantSelect" class="font-semibold form-label">Select Accountant</label>
            ...
            <div class="mt-4 row">
                <div class="col-sm-6">
                <label for="receiptFile" class="font-semibold form-label">Upload Receipt (Image)</label>
            ...
            <div class="flex gap-4 mt-4">
              ...
              <span>
                <router-link to="/admin-view/receipts" class="flex items-center gap-2 px-4 py-2 text-gray-700 bg-gray-200 rounded hover:bg-gray-300">
  ...
  async function submitReceipt() {
    ...
    try {
      ...
      router.push('/admin-view/receipts');
    } catch (error) {
      handleError(error);
    } finally {
      isLoading.value = false;
