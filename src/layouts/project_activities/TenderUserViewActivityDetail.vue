<template>
    <div class="container p-6 mx-auto" style="font-family: 'cygre', serif; font-size: 17px">
      ...
      <div v-if="activity" class="p-6 bg-white rounded-lg shadow-lg">
        ...
        <!-- Edit Button -->
        <router-link to="/tenderuser/view-activityDetail" class="flex items-center gap-2 px-4 py-2 text-gray-700 bg-gray-200 rounded hover:bg-gray-300">
        ...
        <div class="p-6 bg-white rounded-lg shadow-lg w-[500px]">
          ...
          <form @submit.prevent="saveChanges">
            ...
            <div class="flex justify-end">
                <router-link to="/admin/view-activityDetail" class="flex items-center gap-2 px-4 py-2 text-gray-700 bg-gray-200 rounded hover:bg-gray-300">
  <i class="fa fa-times"></i> Cancel
</router-link>
  ...
  async function saveChanges() {
    ...
    try {
      ...
      if (response.data.status === 'success') {
        ...
        router.push('/admin/view-activityDetail'); // Navigate to the specified route after success
      } else {
