        ...
        <div class="p-6 bg-white rounded-lg shadow-lg w-[500px]">
          ...
          <form @submit.prevent="saveChanges">
            ...
            <div class="flex justify-end">
              <router-link to="/admin-view/projectActivities" class="flex items-center gap-2 px-4 py-2 text-gray-700 bg-gray-200 rounded hover:bg-gray-300">
  ...
  async function saveChanges() {
    ...
    try {
      ...
      if (response.data.status === 'success') {
        ...
        router.push('/admin-view/projectActivities'); // Navigate to the specified route after success
      } else {
