          ...
          <div class="p-6 bg-white card-body">
            ...
            <div class="mb-4">
              ...
              <button type="button" class="" @click="addTitle" style="color:#283747;">
                <i class="fa fa-plus-circle"></i> Submit update
              </button>
            </div>
            ...
            <div class="mb-4">
              <label for="update_photo" class="form-label">Update Photo (Image)</label>
              <input type="file" id="update_photo" class="w-full px-3 py-2 border rounded form-control" @change="handlePhotoUpload" />
            </div>
  
            <!-- Update File Section -->
            <div class="mb-4">
              <label for="update_file" class=" form-label">Update File (PDF, Excel, etc.)</label>
            ...
            <div class="flex gap-4 mt-4">
              ...
              <span>
                <router-link to="/user/update" class="flex items-center gap-2 px-4 py-2 text-gray-700 bg-gray-200 rounded hover:bg-gray-300">
