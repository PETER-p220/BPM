<template>
    <div class="py-5 add-update" style="font-family: 'cygre', serif; font-size: 23px">
      <div class="container px-4 mx-auto">
        <div class="w-full shadow-lg card">
          ...
          <div class="p-6 bg-white card-body">
            ...
            <div class="mb-4">
              <label for="titles" class="font-semibold form-label">Titles</label>
            ...
            <div class="mb-4">
              <label for="description" class="font-semibold form-label">More Details</label>
              <textarea
                id="description"
                class="w-full px-3 py-2 border rounded form-control"
                rows="4"
