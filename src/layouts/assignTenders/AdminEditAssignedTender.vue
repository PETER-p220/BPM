      ...
      <div class="container px-4 mx-auto">
        <div class="w-full shadow-lg card">
          <div class="flex items-center justify-between px-4 py-2 text-white card-header" style="background-color: #283747;">
            <div><i class="mr-2 fa fa-edit"></i> Edit Assignment</div>
          ...
          <div class="p-6 bg-white card-body">
            <h3 class="mb-4 text-lg font-semibold">Edit Assigned tender</h3>
            ...
            <div class="grid grid-cols-1 gap-4 mt-4 md:grid-cols-2">
              ...
              <div>
                ...
                <select id="assignmentStatus" class="w-full px-3 py-2 border rounded form-control" v-model="assignmentData.status">
            ...
            <div class="mt-4">
              <label for="expireDate" class="font-semibold form-label">Expire Date</label>
