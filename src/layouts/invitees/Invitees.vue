<template>
    <div class="p-4 space-y-4" style="font-family: 'Euclid Circular', sans-serif;">
      ...
      <div class="overflow-x-auto">
        <table class="w-full text-center divide-y divide-gray-200 rounded-table dark:divide-gray-700" id="data-table" style="box-shadow: rgba(149, 157, 165, 0.2) 0px 8px 24px;">
          <thead class="bg-gray-50 dark:bg-neutral-700" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset;">
            <tr>
              ...
              <th class="px-6 py-3 text-sm text-left text-gray-500 dark:text-gray-200">Event Creator</th>
              ...
              <th class="px-6 py-3 text-sm text-left text-gray-500 dark:text-gray-200">InviteeName</th>
          ...
          <tbody class="bg-white divide-y divide-gray-200 dark:bg-dark-header dark:divide-gray-700">
            <tr v-for="(invitee, index) in filteredInvitees" :key="invitee.invitee_id">
              ...
              <td class="table-data">{{ invitee.user_name }}</td>
              ...
              <td class="table-data">{{ invitee.event_type }}</td>
  ...
  async function fetchInvitees() {
    try {
      const response = await axios.get('api/invitees');
