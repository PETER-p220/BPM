      ...
      <div class="mb-8">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          <div>
            ...
            <p class="text-gray-600">Manage and view all security declaration documents</p>
          </div>
      ...
      <div class="bg-white rounded-xl shadow-md p-6 mb-6 border border-gray-200">
        ...
        <div class="mt-4 flex items-center justify-between">
          <div class="text-sm text-gray-600">
            ...
            <span class="font-semibold text-gray-800">{{ filteredData.length }}</span> declarations
          </div>
          
          <!-- Active Filter Badge -->
          <div v-if="filter" class="flex items-center gap-2">
            <span class="text-sm text-gray-500">Active filter:</span>
            <span class="bg-slate-100 text-slate-700 px-3 py-1 rounded-full text-xs font-medium flex items-center gap-2">
              {{ filter }}
              <button @click="filter = ''" class="hover:text-slate-900">
              ...
              >
                ...
                <td class="px-6 py-4 text-sm">
                  <div class="flex items-center gap-2">
                    ...
                    <div>
                      <p class="font-medium text-gray-800">{{ securityDeclaration.tender.title }}</p>
                ...
                <td class="px-6 py-4 text-sm">
                  <div class="flex items-center gap-2">
                    <div class="w-8 h-8 bg-gradient-to-br from-slate-400 to-slate-600 rounded-full flex items-center justify-center text-white text-xs font-semibold">
                      <i class="fas fa-user"></i>
                    </div>
                    <div>
                      <p class="text-gray-700">{{ securityDeclaration.receiver_email || 'N/A' }}</p>
                ...
                <td colspan="5" class="px-6 py-16 text-center">
                  <div class="flex flex-col items-center justify-center">
                    <div class="w-20 h-20 bg-slate-100 rounded-full flex items-center justify-center mb-4">
                      <i class="fas fa-shield-alt text-slate-300 text-4xl"></i>
                    </div>
                    <p class="text-gray-500 text-lg font-medium mb-2">No security declarations found</p>
                    ...
                    <router-link 
                      ...
                      class="bg-slate-600 hover:bg-slate-700 text-white font-medium px-6 py-2 rounded-lg transition"
                    >
              ...
              <div class="hidden md:flex items-center gap-1">
                <button
                  ...
                  :class="[
                    ...
                    page === currentPage
                      ? 'bg-slate-600 text-white border-slate-600 font-semibold shadow-md'
                      : page === '...'
