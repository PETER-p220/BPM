<template>
    <div class="py-5 add-attendance" style="font-family: 'cygre', serif; font-size: 17px">
      <div class="container px-4 mx-auto">
        <div class="w-full shadow-lg card">
          <div class="flex items-center justify-between px-4 py-2 text-white card-header" style="background-color: #283747;">
            <div><i class="mr-2 fa fa-calendar-check"></i> Create Attendance</div>
          ...
          <div class="p-6 bg-white card-body">
            ...
            <div class="flex gap-4 mt-4">
              ...
              <span>
                <router-link to="/attendance" class="flex items-center gap-2 px-4 py-2 text-gray-700 bg-gray-200 rounded hover:bg-gray-300">
...
async function submitAttendance() {
  ...
  try {
    ...
    router.push('/create/userattendance');
  } catch (error) {
    handleError(error);
  } finally {
    isLoading.value = false;
