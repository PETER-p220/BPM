      ...
      <div class="mb-8 flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p class="mt-1.5 text-sm text-gray-500 dark:text-gray-400">
            Review, approve or reject purchase requests from projects
          </p>
        </div>
      ...
      <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div class="relative flex-1 max-w-lg">
          ...
          <input
            v-model="filter"
            type="text"
            placeholder="Search by engineer, item, vendor, status..."
          ...
          <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
              ...
              >
                ...
                <td class="max-w-md px-6 py-4 text-sm text-gray-900 dark:text-gray-100">
                ...
                <td class="whitespace-nowrap px-6 py-4 text-right text-sm font-bold text-gray-900 dark:text-gray-100">
...
function exportToExcel() {
  const data = filteredRequests.value.map((r, i) => ({
    ...
    Amount: formatCurrency(r.amount_purchased) || 'N/A',
    Status: r.status || 'N/A',
...
function exportToPDF() {
  ...
  doc.setFontSize(16)
  doc.text('Purchase Requests', 14, 20)

  const headers = [
    ['#', 'Engineer', 'Item', 'Vendor', 'Account', 'Contact', 'Qty', 'Amount', 'Status', 'Rejection Reason', 'Created']
  ]
