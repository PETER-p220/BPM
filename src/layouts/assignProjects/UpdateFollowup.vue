      ...
      <div class="w-full shadow-lg card">
        ...
        <div class="p-6 bg-white card-body">
          ...
          <div class="mt-4">
            ...
            <input type="text" id="contractTitle" class="w-full px-3 py-2 border rounded form-control" v-model="projectData.contract.title"  />
          </div>
          ...
          <div class="mt-4">
            ...
            <select 
              ...
              :class="{ 'border-red-500': errors.project_status }" 
