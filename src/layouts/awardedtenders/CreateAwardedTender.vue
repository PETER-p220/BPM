<template>
    <div class="py-5 add-user" style="font-family: 'Trirong', sans-serif; font-size: 17px">
      <div class="container px-4 mx-auto">
        <div class="w-full shadow-lg card">
          ...
          <div class="p-6 bg-white card-body">
            ...
            <div class="mt-4 row">
              <div class="col-sm-12">
                <label for="awardedDocument" class="font-semibold form-label">Awarded Document (PDF, DOC, DOCX)</label>
